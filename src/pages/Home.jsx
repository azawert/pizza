  ...
  const {searchValue} = React.useContext(SearchContext);
    ...
    const fetchPizza = () =>{
      setIsLoading(true)
        ...
        //  await axios.get(`https://62a2fcc35bd3609cee5f6470.mockapi.io/items?limit=4&page=${currentPage}&${category}&sortBy=${sortBy}&order=${order?'asc':'desc'}${search}`).then(res=>{
        //   setPizzas(res.data)
        //   setIsLoading(false)
        //  })
        try{
